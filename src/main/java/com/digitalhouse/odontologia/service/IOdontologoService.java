...
public interface IOdontologoService {
    ...
    Odontologo buscarPorEmail(String email) throws ResourceNotFoundException;
    List<Odontologo> buscarPorEspecialidad(String especialidad) throws ResourceNotFoundException;
